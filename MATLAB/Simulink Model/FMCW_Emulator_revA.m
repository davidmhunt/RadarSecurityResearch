    ...
    methods
        ...
        function initialize_range_spoof(obj)
            if contains(obj.emulation_mode,"similar slope")
                obj.FrequencySlope_MHz_us = obj.Radar.FrequencySlope_MHz_us + obj.Radar.FrequencySlope_MHz_us * 0.015;
                obj.additional_time_delay_us = ...
                    0.4 * obj.Radar.Chirp_Tx_Bandwidth_MHz *...
                    (1/obj.Radar.FrequencySlope_MHz_us - 1/obj.FrequencySlope_MHz_us); %prevoiusly used the 50% mark on the BW instead of 60%
            end
        end
            ...
            for chirp = 1:int32(obj.Radar.NumChirps)
                ...
                waveform = cos(pi * obj.FrequencySlope_MHz_us * 1e12 ...
                    * obj.t.^(2) + phase_shift + obj.additional_phase_variation(chirp)) + ...
                    1i * sin(pi * obj.FrequencySlope_MHz_us ...
                    * obj.t.^(2) + phase_shift + obj.additional_phase_variation(chirp));
