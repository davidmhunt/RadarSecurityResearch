...
class FMCW_radar_py(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, int(samp_rate * 2 * target_distance / (3e8)))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_delay_0.set_dly(int(self.samp_rate * 2 * self.target_distance / (3e8)))
